...
db.Translator.belongsToMany(db.Language, {through: 'Translator_Languages', as: 'language'});
db.Language.belongsToMany(db.Translator, {through: 'Translator_Languages', as: 'translator'});
